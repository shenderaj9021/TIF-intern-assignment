...
const slugify = require("slugify") // to create slug name
...
async function createCommunity(req, res) {
  ...
  try {
    ...
    if (communityExist) {
      ...
      let snowflakeId = await Snowflake.generate().toString();   // creater Snowflack id
      ...
      // To add owner as memeber of that community automatically
...
// To get all member of community
...
// To get list of communities owned by user
